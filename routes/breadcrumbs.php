...
Breadcrumbs::register('admin.companies.users', function (Generator $breadcrumbs, App\Models\Company $company) {
	$breadcrumbs->push(__('views.admin.company.index.title'), route('admin.companies'));
